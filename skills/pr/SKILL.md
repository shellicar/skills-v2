...
Opening a PR needs the SC's approval, and the tool is what collects it. Where these tools
are absent, present the command with the draft flag and ask for that approval instead.
